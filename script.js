const listItems = [
    ...
    "Let world do whatever they desire, you stay on the path you chose.",
    ...
    "Sacrifices made today shall return as rewards tomorrow.",
    ...
    "Even when times are hard, do not let go of your kindness & virtues.",
    ...
    "Life only gets harder when you choose the easy way out.",
    "Stop doubting yourself, Be proud of how far you've come.",
    "The only wall you need to climb...is the one you build inside YOUR MIND",
    ...
    "If God took away something you never imagned loosing, He also gives you something you never imagined having.",
